...
module.exports = {
    ...
    BOTSK: process.env.BOT_NAME === undefined ? '𝐌𝐈𝐍𝐍𝐀𝐋' : process.env.BOT_NAME,
    LOGOSK: process.env.ALL_IMG === undefined ? 'https://i.ibb.co/KxMC8YH/pikachu.jpg' : process.env.ALL_IMG,
    SLINK: process.env.SOCIAL_MEDIA === undefined ? 'https://www.instagram.com/_l_e_g_e_n_d_g_o_d/' : process.env.SOCIAL_MEDIA,
