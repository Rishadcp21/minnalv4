...
module.exports = {
    ...
    CHANNEL: 'https://t.me/Legend_god001',
    SESSION: process.env.CONNECTION_CODE === undefined ? '' : process.env.CONNECTION_CODE,
    ANTİLİNK: process.env.ANTİ_LİNK === undefined ? 'false' : process.env.ANTİ_LİNK,
    AUTOBİO: process.env.AUTO_BİO === undefined ? 'false' : process.env.AUTO_BİO,
    AFN: process.env.ALL_CAPTION === undefined ? 'Made By MinnalBot' : process.env.ALL_CAPTION,
    ...
    BOTSK: process.env.BOT_NAME === undefined ? '𝑴𝑰𝑵𝑵𝑨𝑳 𝑩𝑶𝑻' : process.env.BOT_NAME,
    LOGOSK: process.env.ALL_IMG === undefined ? 'https://www.linkpicture.com/q/PicsArt_12-01-09.26.44_6.jpg' : process.env.ALL_IMG,
    SLINK: process.env.SOCIAL_MEDIA === undefined ? 'https://www.instagram.com/l_e_g_e_n_d_g_o_d/' : process.env.SOCIAL_MEDIA,
    ...
    SUPPORT: "917510241003-1627138839",
    SUPPORT2: "917510241003-1632403322",
    SUPPORT3: "917510241003-1621015274"
};
